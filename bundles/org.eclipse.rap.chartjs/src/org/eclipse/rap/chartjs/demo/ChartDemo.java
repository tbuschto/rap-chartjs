...
public class ChartDemo extends AbstractEntryPoint {
  ...
  protected void createContents( Composite parent ) {
    ...
    rowData.addRow( new int[] { 28, 48, 40, 19, 96, 27, 100 }, new ChartStyle( 220, 220, 220 ) );
    rowData.addRow( new int[] { 27, 100, 28, 48, 40, 19, 96 }, new ChartStyle( 151, 187, 205 ) );
    ChartPointData pointData = new ChartPointData();
    pointData.addPoint( 28, new ChartStyle( 250, 187, 105 ) );
    pointData.addPoint( 88, new ChartStyle( 50, 187, 205 ) );
    pointData.addPoint( 51, new ChartStyle( 10, 17, 133 ) );
